import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/data2/dev/fenglijun/SKMS/node_modules/_react-intl@3.12.0@react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/data2/dev/fenglijun/SKMS/node_modules/_warning@4.0.3@warning/warning.js';

import { plugin } from '../core/umiExports';

export * from '/data2/dev/fenglijun/SKMS/node_modules/_react-intl@3.12.0@react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/data2/dev/fenglijun/SKMS/src/locales/en-US.js')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/data2/dev/fenglijun/SKMS/src/locales/pt-BR.js')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/data2/dev/fenglijun/SKMS/src/locales/zh-CN.js')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/data2/dev/fenglijun/SKMS/src/locales/zh-TW.js')),
    },
    locale: 'zh-TW',
    antd: {
