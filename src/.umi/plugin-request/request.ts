/**
 * Base on https://github.com/umijs//data2/dev/fenglijun/SKMS/node_modules/_umi-request@1.2.19@umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/data2/dev/fenglijun/SKMS/node_modules/_umi-request@1.2.19@umi-request';
// @ts-ignore
...
import useUmiRequest from '/data2/dev/fenglijun/SKMS/node_modules/_@umijs_use-request@1.4.2@@umijs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/data2/dev/fenglijun/SKMS/node_modules/_@umijs_use-request@1.4.2@@umijs/use-request/lib/types';
